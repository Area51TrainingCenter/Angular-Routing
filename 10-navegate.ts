	...
	<nav class="navbar navbar-default">
	        <div class="container-fluid">
	          <div class="navbar-header">
	            ...
	            <a class="navbar-brand" (click)="irAListado()">Area51 Alumnos</a>
	          </div>
	          <div id="navbar" class="navbar-collapse collapse">
	            <ul class="nav navbar-nav">
	              <li class="active"><a (click)="irAListado()">Inicio</a></li>
	              <li><a (click)="irAInsercion()">Inserción</a></li>
	            </ul>
	          </div>
	        </div>
	      </nav>
...
class appCabecera{
	...
	irAInsercion(){
		this.router.navigate(["insercion"]);
	}
